...
#Idea:add component number for each sequence in a fasta file (blast query) 
#based on the fasta header name and return dataframe with matrix+partition 
#name and correponding component number
